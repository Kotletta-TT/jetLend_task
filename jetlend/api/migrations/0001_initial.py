...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Passport',
            fields=[
                ('investor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='api.investor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Start', 'New'), ('Level 1', 'Level 1'), ('Level 2', 'Level 2'), ('Confirm', 'Confirm'), ('Failure', 'Failure')], default='Start', max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='docs', to=settings.AUTH_USER_MODEL)),
            ],
            options={
